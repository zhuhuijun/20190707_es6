	...
	var Lottery = function (_mix) {
	    ...
	    _createClass(Lottery, [{
	        ...
	        value: function initEvent() {
	            var self = this;
	            (0, _jquery2.default)('#plays').on('click', 'li', self.playChangeNav.bind(self));
	...
	var Base = function () {
	    ...
	    _createClass(Base, [{
	        ...
	        value: function setOmit(omit) {
	            ...
	            (0, _jquery2.default)(self.omit).each(function (index, item) {
	        ...
	        value: function getRandomCode(e) {
	            ...
	            var play = self.cur_play.math(/\d+/g)[0];
	            if ('0' === num) {
